                ...
                <Col lg="6" xl="4">
                  <Card className="card-stats mb-4 mb-xl-0">
                    <CardBody>
                      ...
                      <p className="mt-3 mb-0 text-muted text-sm">
                        <span className="text-nowrap"><a href="/user/fanpage">Tới quản lý fanpage</a></span>
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                <Col lg="6" xl="4">
                  <Card className="card-stats mb-4 mb-xl-0">
                    <CardBody>
                      ...
                      <p className="mt-3 mb-0 text-muted text-sm">
                        <span className="text-nowrap"><a href="/user/user-plan">Tới quản lý gói</a></span>
                      </p>
                    </CardBody>
                  </Card>
                </Col>
                <Col lg="6" xl="4">
                  <Card className="card-stats mb-4 mb-xl-0">
                    <CardBody>
                      ...
                      <p className="mt-3 mb-0 text-muted text-sm">
                        <span className="text-nowrap"><a href="/user/campaign">Tới quản lý chiến dịch</a></span>
                      </p>
                    </CardBody>
                  </Card>
                </Col>
